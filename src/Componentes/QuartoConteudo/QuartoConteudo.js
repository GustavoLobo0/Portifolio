...
export function QuartoConteudo() {
    return (
        <>
            <div className="maisSobreMim" id="Gostos">
                <h2 className="Sobre">Gostos Pessoais</h2>
                <div className="linha1"></div><div className="topico1"><p>Além de minha paixão por desenvolvimento web, tenho um interesse especial por aviões militares, especialmente caças a jatos. Fascinado pela engenharia e tecnologia envolvidas, gosto de explorar as características desses modelos e entender o que os torna tão poderosos e únicos.</p></div>
